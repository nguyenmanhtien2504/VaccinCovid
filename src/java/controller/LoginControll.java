...
public class LoginControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        UserInfo lo = dao.checkLogin(new UserInfo(username, password));
        //LoginL lo = dao.login(new LoginL(username, password));
        if(lo == null){
            ...
            request.getRequestDispatcher("home-admin-page.jsp").forward(request, response);
        }
    }
