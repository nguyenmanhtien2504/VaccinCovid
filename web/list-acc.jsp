        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <c:forEach var="lis" items="${Li}">

                            <tr>
    <!--                            <th scope="row">${lis.getId()}</th>-->
                                <td><img src="${lis.getImg()}" width="50px" height="50px"></td>
                                <td>${lis.getUsername()}</td>
                                <td>${lis.getPasswword()}</td>
                                <td>${lis.getIsuser()}</td>
                                <td>${lis.getIsadmin()}</td>
                                <td>
                                    <a href="updateacc?sid=${lis.getId()}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                </td>
                                <td>
